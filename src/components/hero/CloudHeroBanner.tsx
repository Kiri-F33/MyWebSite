    ...
    <div className="relative w-full cloud-hero-banner pt-12 pb-16 px-6 sm:px-12 overflow-hidden text-white mb-10 border-b border-white/20">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-4 text-center lg:text-left">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-white text-xs font-mono font-semibold tracking-wider border border-white/30">
            {hero.badge}
          </span>
          ...
          <p className="text-white/90 text-sm sm:text-base max-w-xl mx-auto lg:mx-0 leading-relaxed font-sans">
            {hero.subtitle}
          </p>
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-4">
            <a
              href="#galeria-bolhas"
              className="px-6 py-3 rounded-full bg-white text-slate-800 font-bold text-xs uppercase tracking-wider shadow-lg hover:bg-slate-100 transition-all active:scale-95"
            >
              {hero.btnExplore}
            </a>
            ...
            <button
              ...
              className="px-6 py-3 rounded-full bg-[#34D399] text-slate-950 font-bold text-xs uppercase tracking-wider shadow-lg hover:brightness-110 transition-all active:scale-95 border border-white/30"
            >
              {hero.btnAddArt}
            </button>
          </div>
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-white/20 backdrop-blur-md border border-white/40 p-4 shadow-2xl overflow-hidden flex flex-col items-center justify-center text-center">
            ...
            <div className="absolute bottom-3 left-3 right-3 p-3 rounded-xl bg-slate-900/80 backdrop-blur-md border border-white/20 text-white">
              <p className="font-serif text-xs font-bold text-[#34D399]">{hero.placeholderTitle}</p>
              <p className="text-[10px] text-slate-300">{hero.placeholderSubtitle}</p>
            </div>
          </div>
        </div>
      </div>
