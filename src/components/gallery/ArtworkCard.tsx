...
export default function ArtworkCard({ artwork, onSelect }: ArtworkCardProps) {
  ...
  return (
    <div
      ...
      className="group relative cursor-pointer overflow-hidden rounded-3xl navy-card transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 flex flex-col"
    ...
    >
      ...
      <div className="relative aspect-[3/4] w-full overflow-hidden">
        ...
        <div className="absolute top-3 left-3 z-10">
          <span className="px-3 py-1 text-[11px] font-mono font-semibold rounded-full bg-slate-900/70 backdrop-blur-md text-white border border-white/20 shadow-sm">
        ...
        <div className="absolute bottom-3 left-3 z-10">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono border border-white/10"
            style={{ background: 'var(--badge-author-bg)', color: 'var(--badge-author-text)' }}
          >
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        ...
        <div className="mt-3 pt-2 border-t flex items-center justify-between text-xs font-mono"
