...
export const BLOG_POSTS_DATA: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Quando aceitamos que nem todo desenho precisa virar uma obra de arte pronta para o portfólio, a pressão desaparece e a criatividade volta a fluir naturalmente.'
    ],
